			...
			<div class="text-center">
				<ul class="pagination">
					...
					<%
						if (pageNumber > 1) {
					%>
					<li><a href="rmyapplication?pageNumber=<%=pageNumber - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					...
					%>
								...
								<a href="rmyapplication?pageNumber=<%=i%>"><%=i%></a></li>
					<%
							}
					...
					%>
					<li><a href="rmyapplication?pageNumber=<%=pageNumber + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
