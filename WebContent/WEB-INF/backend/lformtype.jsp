				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							%>
							<td> 
							<a href="uformtype?formtypeId=<%=row.get(0)%>"><span
			...
			<div class="text-center">
				<ul class="pagination">
					...
					<%
						if (pageNumber > 1) {
					%>
					<li><a href="lformtype?pageNumber=<%=pageNumber - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					...
					<li <%=(i == pageNumber) ? " class=\"active\"" : ""%>><a
						href="lformtype?pageNumber=<%=i%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a href="lformtype?pageNumber=<%=pageNumber + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
